      ...
      for (int finY = posY; finY < posY + Alto; finY++)
      {
         ...
         do
         {
            ...
            {   
               ...
               {
                  char car1 = Dibujo[iy-posY][ix-posX];
                  int  ch1  = Caracter[car1];
                  int  Atr1 = Atributo[car1];
                  int  CT1  = ColorTexto[car1];
                  int  CF1  = ColorFondo[car1];
...
main (void)
{
   ...
   int      campo = 0, maxGoles = 15, level = 0,
            maxTiempo = 300, opcion;
   bool     ctrlA = HUMANO, ctrlB = HUMANO;
   int      Ancho = STDP::TamX();
   ...
   MenuTmp.PonCadenaOpcion (1, " 5 Minutos");
   MenuTmp.PonCadenaOpcion (2, "10 Minutos");
   MenuTmp.PonCadenaOpcion (3, "25 Minutos");
      ...
      switch(opcion)
      {
         ...
         case 3:
         {
            switch (MenuTmp.Ejecutar(FPS))
            {
               ...
               case 1: { maxTiempo =  300; break; }
               case 2: { maxTiempo =  600; break; }
               case 3: { maxTiempo = 1500; break; }
