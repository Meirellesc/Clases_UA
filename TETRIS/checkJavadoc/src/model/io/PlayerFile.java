...
public class PlayerFile implements IPlayer{
	...
	/**
	 * @variable camino del fichero.
	 */
	private BufferedReader br;
	
	/**
	 * @variable "contador de líneas".
	 */
	private int currentLine = 0;
	
	/**	[ENG] Constructor that keep the parameter which represent a movements sequence read from a file. 
	 *  [SPA] Constructor que almacena el parámetro cuyo representa la secuencia de movimientos leídos de un fichero.
	 * 
	 * @param b = input the file's path / introduce el camino del fichero.
	 */
